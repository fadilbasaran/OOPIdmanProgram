...
public class Idman {
    ...
    public void burpeeYap(int sayi){
        ...
        if (burpee_sayisi-sayi<0) {
            System.out.println("Hedeflediğin burpee sayisi geçtin. Tebrikler...");
            burpee_sayisi=0;
     ...
     public void pushupYap(int sayi){
        if (pushup_sayisi==0) {
            System.out.println("Yapacak pushub kalmadı...");
        }
        if (pushup_sayisi-sayi<0) {
            System.out.println("Hedeflediğin pushub sayisi geçtin. Tebrikler...");
            pushup_sayisi=0;
            System.out.println("Kalan Pushub : "+pushup_sayisi);
        }
        else{
            pushup_sayisi-=sayi;
     ...
     public void situpYap(int sayi){
        ...
        if (situp_sayisi-sayi<0) {
            System.out.println("Hedeflediğin situp sayisi geçtin. Tebrikler...");
            situp_sayisi=0;
            ...
            System.out.println("Kalan Pushub Sayısı : "+situp_sayisi);
        }
    }
      public void squatYap(int sayi){
        ...
        if (squat_sayisi-sayi<0) {
            System.out.println("Hedeflediğin squat sayisi geçtin. Tebrikler...");
            squat_sayisi=0;
